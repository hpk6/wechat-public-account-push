export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx96388330dda2aa21",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "6f63892c0e3d92d8856d428c9c5038d7",
  ...
  USERS: [
    {
      ...
      id: "oeMSg6i4FGDX1olJkOd7tQpKMoMk",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "oeMSg6njOOGZ94XAglURce15e2ZI",
      // 所在省份
      province: "山西",
      // 所在城市
      city: "太原",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2003", "date": "02-14"},
  ...
  CALLBACK_TEMPLATE_ID: "oeMSg6njOOGZ94XAglURce15e2ZI",
